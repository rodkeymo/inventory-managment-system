        ...
        <div class="navbar-nav ms-auto d-flex align-items-center">
            ...
            <div class="nav-item dropdown me-3 position-relative">
                <a class="nav-link" href="{{ route('notifications.index') }}" aria-label="Notifications">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 48 48" style="background: none;>
                    ...
                    <span class="badge position-absolute text-white" 
                        style="top: 15px; right:16px; font-size: 0.75rem; padding: 0.1rem 0.15rem; border-radius: 30%;background-color: green;">
